""" Standard ESNS without exploration """
...
class ESNSStandardNoExploration(ESNSNoExploration):
    ...
    def _create_eii(self, column: int) -> torch.LongTensor:
        ...
        # this has been adapted very quickly from the original code and is a bit slow
